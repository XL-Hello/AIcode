...
## 个人代码规范过滤 (code_spec/dreame_code.md)

在审查的每个环节前，必须优先加载并解析当前技能根目录下的 `dreame_code.md` 文件，用于过滤个人代码规范偏好。

- 当 `dreame_code.md` 中的约定与通用规范冲突时，优先遵循 `dreame_code.md`
- 审查报告中的每一条建议，应标注其来源是`通用规范`还是`dreame_code.md`
- 对于 `dreame_code.md` 中明确声明「不作为问题」的风格差异，不应在报告中作为问题输出
...
| [code_spec/dreame_code.md](code_spec/dreame_code.md) | 个人代码规范 |
